...
const Portfolio = () => {
  ...
  const skills = {
    'Data Analysis': ['SQL', 'Power BI', 'Excel', 'Python', 'Data Cleaning', 'EDA', 'Statistical Analysis'],
  ...
  const experiences = [
    ...
    },
    {
      ...
      achievements: [
        ...
        'Optimized code efficiency by 30%'
      ]
    },
    {
      company: 'Alfido Tech',
      ...
      achievements: [
        ...
        'Focused on modular programming',
  ...
  const projects = [
    {
      ...
      description: 'Power BI dashboard analyzing employee attrition with insights from 1400+ records',
      tech: ['Power BI', 'SQL', 'Excel'],
      github: '#'
    },
    {
      title: 'Blinkit Sales Analytics Dashboard',
      description: 'Tracked KPIs including revenue and ratings with SQL + Power BI visualizations',
      tech: ['Power BI', 'SQL', 'Excel'],
      github: '#'
    },
    {
      title: 'Urban Threads Order Analysis',
      description: 'Excel dashboard analyzing sales and returns for Q4 2024 e-commerce data',
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative pt-20 px-6">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <div className="mb-8 animate-fadeIn">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 bg-gradient-to-r from-purple-400 via-blue-400 to-purple-400 bg-clip-text text-transparent animate-gradient">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <button className="px-8 py-4 border-2 border-purple-500 rounded-full text-purple-400 font-semibold hover:bg-purple-500/10 transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2">
              <Download size={20} />
              Download Resume
            </button>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-purple-500/20 shadow-2xl hover:shadow-purple-500/20 transition-all duration-500">
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
              Entry-Level Data Analyst with strong foundation in SQL, Power BI, Python, and Excel. 
              Passionate about transforming raw data into actionable insights through dashboards, 
              data visualization, and statistical analysis. Proven track record of delivering 
              15-30% efficiency improvements through data-driven solutions.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              ...
              >
                ...
                <a href={project.github} className="inline-flex items-center gap-2 text-blue-400 hover:text-blue-300 transition-colors text-sm">
                  <Github size={16} />
                  View on GitHub
                </a>
              </div>
